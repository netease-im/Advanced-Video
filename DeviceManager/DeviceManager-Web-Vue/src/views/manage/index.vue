...
<script>
    ...
    export default {
        ...
        data() {
            return {
                drawer: false,
                videoResolution: WebRTC2.VIDEO_QUALITY_480p,
                videoFrameRate: WebRTC2.CHAT_VIDEO_FRAME_RATE_15,
                ...
                videoResolutionOptions: [{
                    label: '分辨率 320x180',
                    value: WebRTC2.VIDEO_QUALITY_180p
                }, {
                    label: '分辨率 640x480',
                    value: WebRTC2.VIDEO_QUALITY_480p
                }, {
                    label: '分辨率 1280x720',
                    value: WebRTC2.VIDEO_QUALITY_720p
                }, {
                    label: '分辨率 1920x1080',
                    value: WebRTC2.VIDEO_QUALITY_1080p
                }],
                videoFrameRateOptions: [{
                    label: '视频通话帧率 最大取每秒5帧',
                    value: WebRTC2.CHAT_VIDEO_FRAME_RATE_5
                }, {
                    label: '视频通话帧率 最大取每秒10帧',
                    value: WebRTC2.CHAT_VIDEO_FRAME_RATE_10
                }, {
                    label: '视频通话帧率 最大取每秒15帧',
                    value: WebRTC2.CHAT_VIDEO_FRAME_RATE_15
                }, {
                    label: '视频通话帧率 最大取每秒20帧',
                    value: WebRTC2.CHAT_VIDEO_FRAME_RATE_20
                }, {
                    label: '视频通话帧率 最大取每秒25帧',
                    value: WebRTC2.CHAT_VIDEO_FRAME_RATE_25
                }],
                isSilence: false,
                isStop: false,
                max: 4,
