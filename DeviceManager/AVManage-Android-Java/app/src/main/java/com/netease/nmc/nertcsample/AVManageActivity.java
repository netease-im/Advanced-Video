...
public class AVManageActivity extends BasicActivity {
    ...
    protected int getPanelLayoutId() {
        return R.layout.panel_avmanage;
    }
    ...
    private void loadConfig(boolean reload) {
        configFromPreference(
                getSharedPreferences(getString(R.string.shared_prefs_avmanage), Context.MODE_PRIVATE), reload);
    }
