...
public:
    ...
    */
     ...
     * @since V4.2.202
     * @param file_path 文件文件绝对路径。例如：xxx/data/beauty/nebeauty
     * @return
     * - 0: 方法调用成功。
     ...
     * @since V4.2.202
     * @param file_path 滤镜资源或模型所在路径。例如 `e:\Resources\Filters\filters.bundle\filter_style_白皙\template.json`。
     *
     * @return
     * - 0: 方法调用成功。
     * - -1: 方法调用失败。
     ...
     * 
     * @since V4.2.202
     * @param file_path 贴纸资源或模型所在路径。例如 `e:\Resources\StickerZipAndIcons\2d_sticker.bundle\bunny\template.json`。
     *
     * @return
     * - 0: 方法调用成功。
     * - -1: 方法调用失败。
     ...
     *
     * @param file_path 美妆模型所在路径。例如 `e:\Resources\StickerZipAndIcons\makeup_sticker.bundle\makeup\template.json`。
     *
     * @return
     * - 0: 方法调用成功。
     * - -1: 方法调用失败。
