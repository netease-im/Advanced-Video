...
| <div style="width:400px">事件</div> | <div style="width:600px">描述</div> | <div style="width:200px">起始版本</div> |
|---|---|---|
| \ref nertc::IRtcEngineEx::startBeauty "startBeauty" | 开启美颜功能模块。 | V4.2.202|
| \ref nertc::IRtcEngineEx::stopBeauty "stopBeauty" | 结束美颜功能模块。 |V4.2.202|
| \ref nertc::IRtcEngineEx::enableBeauty "enableBeauty"  | 开启或关闭美颜功能。 |V4.2.202|
| \ref nertc::IRtcEngineEx::enableBeautyMirrorMode "enableBeautyMirrorMode" | 启用美颜时，启用或关闭镜像模式。 |V4.2.202|
| \ref nertc::IRtcEngineEx::setBeautyEffect "setBeautyEffect" | 设置指定美颜类型的强度。 |V4.2.202|
| \ref nertc::IRtcEngineEx::getBeautyEffect "getBeautyEffect"  | 获取指定美颜类型的强度设置。 |V4.2.202|
| \ref nertc::IRtcEngineEx::addBeautyFilter "addBeautyFilter"  | 添加滤镜效果。 |V4.2.202|
| \ref nertc::IRtcEngineEx::removeBeautyFilter "removeBeautyFilter"  | 取消滤镜效果。 |V4.2.202|
| \ref nertc::IRtcEngineEx::setBeautyFilterLevel "setBeautyFilterLevel"  | 设置滤镜强度。 |V4.2.202|
| \ref nertc::IRtcEngineEx::addBeautySticker "addBeautySticker"  | 添加贴纸效果。 |V4.2.202|
| \ref nertc::IRtcEngineEx::removeBeautySticker "removeBeautySticker"  | 取消贴纸效果。 |V4.2.202|
| \ref nertc::IRtcEngineEx::addBeautyMakeup "addBeautyMakeup"  | 	添加美妆效果。 |V4.2.202|
| \ref nertc::IRtcEngineEx::removeBeautyMakeup "removeBeautyMakeup"  | 取消美妆效果。 |V4.2.202|
