...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        shareScreenBtn = new QPushButton(centralwidget);
        shareScreenBtn->setObjectName(QString::fromUtf8("shareScreenBtn"));
        shareScreenBtn->setGeometry(QRect(320, 570, 75, 23));
        screen_comboBox = new QComboBox(centralwidget);
        screen_comboBox->setObjectName(QString::fromUtf8("screen_comboBox"));
        screen_comboBox->setGeometry(QRect(200, 570, 111, 23));
        label = new QLabel(centralwidget);
        label->setObjectName(QString::fromUtf8("label"));
        label->setGeometry(QRect(150, 570, 51, 23));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        shareScreenBtn->setText(QCoreApplication::translate("MainWindow", "\345\261\217\345\271\225\345\205\261\344\272\253", nullptr));
        label->setText(QCoreApplication::translate("MainWindow", "\351\200\211\346\213\251\345\261\217\345\271\225", nullptr));
    } // retranslateUi
