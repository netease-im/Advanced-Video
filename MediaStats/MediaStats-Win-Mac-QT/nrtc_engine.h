...
class NRTCEngineEvent : public IRtcEngineEventHandlerEx,public IRtcMediaStatsObserver
{
    NRTCEngine& m_engine;
public:
...
signals:
    ...
    void rtcStats(const nertc::NERtcStats& status);
...
private:
    ...
    std::unique_ptr<NRTCEngineEvent> rtc_engine_handler_;
    QString app_key_;
