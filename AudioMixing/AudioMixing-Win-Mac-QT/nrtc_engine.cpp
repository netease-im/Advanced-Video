...
int NRTCEngine::enableAudio(bool enabled)
{
...
int NRTCEngine::startAudioMixing(NERtcCreateAudioMixingOption *option)
{
    return rtc_engine_->startAudioMixing(option);
}

int NRTCEngine::stopAudioMixing()
{
    return  rtc_engine_->stopAudioMixing();
}

int NRTCEngine::setAudioMixingSendVolume(uint32_t volume)
{
    return rtc_engine_->setAudioMixingSendVolume(volume);
}

int NRTCEngine::setAudioMixingPlaybackVolume(uint32_t volume)
{
    return rtc_engine_->setAudioMixingPlaybackVolume(volume);
}

int NRTCEngine::playEffect(uint32_t effect_id, NERtcCreateAudioEffectOption *option)
{
    return rtc_engine_->playEffect(effect_id, option);
}

int NRTCEngine::stopEffect(uint32_t effect_id)
{
    return rtc_engine_->stopEffect(effect_id);
}

int NRTCEngine::setEffectSendVolume(uint32_t effect_id, uint32_t volume)
{
    return rtc_engine_->setEffectSendVolume(effect_id, volume);
}

int NRTCEngine::setEffectPlaybackVolume(uint32_t effect_id, uint32_t volume)
{
    return rtc_engine_->setEffectPlaybackVolume(effect_id, volume);
}
