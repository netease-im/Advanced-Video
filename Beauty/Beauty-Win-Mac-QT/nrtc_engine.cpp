...
NRTCParameter NRTCEngine::getParameter()
{
    return rtc_parameter_;
}
...
void NRTCEngine::enableSmooth(bool enable)
{
    m_bBeauty = enable;

}

bool NRTCEngine::isSmoothEnable()
{
    return m_bBeauty;
}

void NRTCEngine::renderFrame(int ntype, void *data, uint32_t width, uint32_t height, int frameid)
{
    emit renderFrameSig(ntype, data, width, height, frameid);
}
